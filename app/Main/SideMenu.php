    ...
    public static function menu()
    {
        return [
            'administracion' => [
                ...
                'sub_menu' => [
                    'empresa' => [
                        ...
                        'title' => 'Empresa',
                        'sub_menu' => [
                            'empresa-perfil-layout' => [
                                'icon' => 'columns',
                                'route_name' => 'empresa-perfil-layout', // Redireccionamiento al hacer click
                                'params' => [
                                    'layout' => 'side-menu'
                                ],
                            ...
                            'empleados-list-layout' => [
                                'icon' => 'clipboard',
                                'route_name' => 'empleados-list-layout',
                                'params' => [
                                    'layout' => 'side-menu'
                                ],
                                'title' => 'Empleados'
            ...
            'contabilidad' => [
                ...
                'title' => 'Contabilidad',
                'sub_menu' => [
                    'catalogo-cuentas-layout' => [
                        'icon' => '',
                        'title' => 'Catalogo de Cuenta',
                        'route_name' => 'error-page',
                        'params' => [
                            'layout' => 'side-menu'
                        ]
                    ...
                    'cierre-agencias-layout' => [
                        'icon' => '',
                        'title' => 'Cierre agencias',
                        'route_name' => 'error-page',
                        'params' => [
                            'layout' => 'side-menu'
                        ]
            ...
            'creditos' => [
                ...
                'sub_menu' => [
                    ...
                    'cartera-activa-layout' => [
                        'icon' => '',
                        'title' => 'Cartera de activa',
                        'route_name' => 'error-page',
                        'params' => [
                            'layout' => 'side-menu'
                        ]
            ...
            'configuracion' => [
                ...
                'sub_menu' => [
                    'empresa' => [
                        ...
                        'title' => 'Sistema',
                        'sub_menu' => [
                            'formas-pago-layout-1' => [
                                'icon' => '',
                                'route_name' => 'error-page', // Redireccionamiento al hacer click
                                'params' => [
                                    'layout' => 'side-menu'
                                ],
